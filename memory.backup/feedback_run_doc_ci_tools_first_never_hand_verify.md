...
metadata: 
  node_type: memory
  type: feedback
  sister_specs: [feedback_independence_for_judgment_not_mechanical.md, feedback_structural_enforcement_when_memory_insufficient.md, feedback_operator_pushback_as_audit_signal.md, feedback_document_as_you_go_over_catch_at_end.md, feedback_ground_design_in_real_code.md, feedback_paste_tool_output_dont_summarize.md, feedback_structure_judgment_loop_not_output.md, feedback_consult_indexes_before_full_reads.md, feedback_verify_by_context_not_count.md, feedback_exhaustive_capture_and_verify_tracking.md, feedback_run_dedicated_audit_skills_not_just_armed_prompts.md, feedback_resource_use_gated_on_existence_not_felt_need.md, feedback_script_transforms_need_output_eyeball.md, feedback_passing_test_is_not_verification.md]
