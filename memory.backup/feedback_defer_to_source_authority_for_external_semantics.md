...
metadata: 
  node_type: memory
  type: feedback
  sister_specs: [feedback_single_source_of_truth_discipline.md, feedback_two_foundations_determinism_vs_correctness.md, feedback_single_source_the_computation_not_just_the_mode.md, project_no_margin_trading.md]
