...
status: first-canonical (7 rows + Session-3 2026-05-30 harvest = 9 rows: +AR-3 documentation-accepted-as-verification, +PL-3 severity-as-skip-license, +CP-1 recurrence bump; populated ongoing via the /close-session harvest Stage)
