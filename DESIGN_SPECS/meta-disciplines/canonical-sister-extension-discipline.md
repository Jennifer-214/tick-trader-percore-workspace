...
1. Check if existing CI tool (`tools/check_<X>.py`) covers same surface family (per-node cfg discipline / wire-format byte preservation / metadata-bit framework / etc.)
