...
### Check 29 — Mechanical citation drift discipline (v5.14.10+)
...
### Check 30 — Predicate-contract-changed audit (v5.14.10+)
...
### Check 31 — Wider-build verification at last sprint close (v5.15.2+; TECH_DEBT-033 closure)
