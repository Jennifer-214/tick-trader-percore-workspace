...
metadata:
  ...
  sister_specs: [feedback_design_once_maintain_forever.md, feedback_fix_toward_future_trajectory_not_static_state.md, feedback_complete_structural_fix_not_incremental_prelive.md]
---
