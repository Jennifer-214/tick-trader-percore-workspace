...
metadata: 
  ...
  sister_specs: [feedback_structural_enforcement_when_memory_insufficient.md, feedback_golden_master_over_reimplemented_oracle.md, feedback_runtime_executor_mode_for_judgment_skills.md, feedback_skill_edit_cohort_checklist.md, feedback_run_doc_ci_tools_first_never_hand_verify.md]
