...
surface: [registry]
sister_specs: [x-macro-registry-with-presence-dispatch.md, cfg-derived-consumer-framework.md, registry-coverage-ci-check-pattern.md]
applies_at_skills: []
---
...
- `DESIGN_SPECS/framework-patterns/per-instance-registry-pattern.md` — the per-instance axis this family operates on
- `DESIGN_SPECS/framework-patterns/universal-cfg-field-registry-pattern.md` — the registry shape
- `DESIGN_SPECS/framework-patterns/universal-registry-bitmap-dispatcher-pattern.md` — bitmap-dispatch primitive each action consumes
- `DESIGN_SPECS/framework-patterns/type-trait-dispatch-via-tt-namespace.md` — action body's typed dispatch
- `DESIGN_SPECS/framework-patterns/x-macro-registry-with-presence-dispatch.md` — parent presence-dispatch pattern
- `DESIGN_SPECS/refactor-patterns/cfg-scope-discipline.md` — scope decisions per registry
- `DESIGN_SPECS/meta-disciplines/pattern-codification-lifecycle.md` — workflow this followed
