...
- **id:** TECH_DEBT-204 · **severity:** MED (apparatus integrity — a CI-guard hook edit can be silently lost on a fresh checkout; non-capital) · **opened:** 2026-06-16 · **status:** open · **surface_tags:** [tooling, ci, pre-commit, sync-workspace, workspace-hygiene, apparatus]
