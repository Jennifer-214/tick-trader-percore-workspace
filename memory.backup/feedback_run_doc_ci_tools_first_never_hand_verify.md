...
metadata: 
  node_type: memory
  type: feedback
  sister_specs: [feedback_independence_for_judgment_not_mechanical.md, feedback_structural_enforcement_when_memory_insufficient.md, feedback_operator_pushback_as_audit_signal.md, feedback_document_as_you_go_over_catch_at_end.md, feedback_ground_design_in_real_code.md]
