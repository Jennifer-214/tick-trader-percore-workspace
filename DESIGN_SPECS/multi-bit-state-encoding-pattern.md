...
This pattern, once applied 2× in the codebase, qualifies for promotion to a CLAUDE.md item per the CLAUDE.local.md "codify design principles as patterns mature" going-forward rule (set 2026-05-09).
