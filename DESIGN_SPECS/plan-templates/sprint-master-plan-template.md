...
- Sub-plan template: `DESIGN_SPECS/plan-templates/future-oriented-plan-template.md`
- Audit-driven pre-coding gate: `DESIGN_SPECS/audit-methodologies/audit-driven-pre-coding-gate.md`
- Pattern codification lifecycle: `DESIGN_SPECS/meta-disciplines/pattern-codification-lifecycle.md`
- CLAUDE.local.md going-forward rule: "Plans + sub-plans codify explicit end goals" (2026-05-18)
