...
metadata: 
  ...
  sister_specs: [feedback_adversarial_framing_default_for_checks.md, feedback_audit_canonical_sister_before_new_infra.md, feedback_v_class_post_implementation_verification.md, feedback_arm_subagents_plan_and_future_aware.md, feedback_invoke_composable_skills_dont_hand_execute.md]
  tags: []
---
