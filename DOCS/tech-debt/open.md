...
- **id:** TECH_DEBT-202 · **severity:** HIGH (heap-use-after-free; memory safety; BLOCKS the .E.0.10 asan-green ship gate) · **opened:** 2026-06-15 · **status:** open · **surface_tags:** [asan, use-after-free, thread-lifecycle, oms, spsc, event-log, .E-spsc-rework, ship-close-gate]
