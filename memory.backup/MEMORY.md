...
- [Document-as-you-go > catch-at-the-end](feedback_document_as_you_go_over_catch_at_end.md) — capture decisions/findings/work-products AT creation; the create→capture gap is where compaction-loss lives
