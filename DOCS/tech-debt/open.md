...
### TECH_DEBT-250 — `check_close_out_completeness.py` (M8 step 5 / AR-8): documented as overdue across 6+ sessions, still unbuilt; operator pushback remains the only trigger

- **id:** TECH_DEBT-250 · **severity:** medium-high (the close ritual is where capture loss happens, and it is guarded by nothing mechanical — every catch to date has come from the operator asking) · **opened:** 2026-07-19 · **status:** open · **surface_tags:** [ci-tooling, close-ritual, capture-audit, m8, ar-8, m7, wh-2]
