...
| 11 — FPN Libraries | 4 | **folded into v5.10.0b** (FPN-e2e refactor already planned; audit Part 11 informs that ship's design) |
...
ships + carryover backlog. The 5 items NOT in the plan are:
- Part 11 (FPN libs, 4 items) — folded into v5.10.0b's existing
  scope. Update v5.10.0b plan when you open it to fold these in.
