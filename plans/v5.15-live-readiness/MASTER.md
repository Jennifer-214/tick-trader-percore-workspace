...
- **`.B.4` (NEW; QUEUED 2026-05-24): Train-serve execution-layer parity structural extract.** Plan body: `subplans/2026-05-24-v5.15.5.F.4d.1.B.4-train-serve-execution-layer-parity.md` v1.0. Closes 4 CRITs (PARITY-027/028/029/030) + 3 HIGHs (PARITY-031 + B2 + auxiliary) + TECH_DEBT-119 structurally via NEW `CoreFrameworks/EngineCommon.hpp` shared helpers (`EngineCommon_BootPerCore` + `EngineCommon_SlowPathCycleOneCore`). M5 meta-discipline Stage 2 DRAFT → Stage 3 first canonical at ship close. ~2-3 days focused; MED-HIGH risk.
