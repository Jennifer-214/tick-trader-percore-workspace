...
metadata: 
  ...
  sister_specs: [feedback_golden_master_over_reimplemented_oracle.md, feedback_phased_pre_rework_correctness_foundation.md, feedback_defer_to_source_authority_for_external_semantics.md, project_no_live_models_dev_test_only.md, project_pessimistic_sim_is_trustworthy.md]
