...
| Concern | Skills |
|---|---|
| **Pre-coding plan verification** | `/precoding-audit-gate` + `/readiness` + `/second-opinion` + `/decision-check` (combined investigate→adversarially-refute a single fix/design DECISION) |
