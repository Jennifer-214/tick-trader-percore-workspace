...
**Lifecycle:** Stage 2 DRAFT v1.0 at v5.15.5.F.4d.1.B.8 (single canonical instance via .B.7 → .B.8 forward-promise closure). Stage 3 first canonical promotion at 2nd application (next ship that has prior-ship forward-promise to close).
