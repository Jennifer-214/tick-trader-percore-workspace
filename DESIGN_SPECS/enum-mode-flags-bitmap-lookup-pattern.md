...
- `DESIGN_SPECS/x-macro-registry-with-presence-dispatch.md` (base X-macro pattern)
- `DESIGN_SPECS/curve-registry-pattern.md` (sister: function pointer dispatch)
- `DESIGN_SPECS/bitmap-flag-api.md` (BITMAP_* macros used in MODE_F_* constants)
- `DESIGN_SPECS/cache-layout-discipline-for-hot-side-structs.md` Rule 8 Pattern 8b (branchless mask dispatch)
- `DESIGN_SPECS/latency-vs-cache-decision-framework.md` (why branchless wins over branchy at >N/16% mispredict)
- `DESIGN_SPECS/structural-fix-preferred-decision-framework.md` (registry as the structural fix per item 19)
