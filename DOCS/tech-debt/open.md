...
### TECH_DEBT-175 — Struct-field produce/consume tracker (the representation-migration meta-pattern's permanent guard)
...
- **Cross-ref:** `representation-migration-completeness.md`; Class 44 + the torn-read class; TECH_DEBT-159 (DOD re-pack consumer); TECH_DEBT-173 (sister branch-scanner tool); D-201.
