...
- [Delegate via the locked spec at implementation](feedback_delegate_via_locked_spec_at_implementation.md) — design=hands-on solo (taste/decisions un-delegatable); implementation=parallelize agents against the LOCKED spec; the docs ARE the delegation substrate
