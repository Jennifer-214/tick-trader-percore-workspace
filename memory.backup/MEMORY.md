...
- [Workspace repo has NO remote — commit only, never push](project_workspace_remote_gone_commit_only.md) — old origin dead post-all-private; unpushed count expected; sync/close end at commit
