...
- `DESIGN_SPECS/per-instance-registry-pattern.md` — per-instance axis this parser dispatches into
- `DESIGN_SPECS/multi-action-registry-walker-family.md` — PARSE action this state machine drives
- `DESIGN_SPECS/cfg-scope-discipline.md` — scope discipline that prevents cross-registry name collisions
- `DESIGN_SPECS/type-trait-dispatch-via-tt-namespace.md` — `tt::cfg_parse_field<T>` per-row parse primitive
- `DESIGN_SPECS/pattern-codification-lifecycle.md` — workflow
